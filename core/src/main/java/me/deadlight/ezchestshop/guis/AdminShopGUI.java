...
public class AdminShopGUI {
    ...
    public void showGUI(Player player, PersistentDataContainer data, Block containerBlock) {
        ...
        if (container.hasItem("admin-view")) {
            ContainerGuiItem guiStorageItem = container.getItem("admin-view")
                    .setName(lm.buttonAdminView())
                    .setLore(lm.buttonAdminViewLore());
            ...
            GuiItem storageGUI = new GuiItem(guiStorageItem.getItem(), event -> {
                ...
                if (player.hasPermission("ecs.admin")
                        || player.hasPermission("ecs.admin.view")) {
        ...
        if (container.hasItem("settings")) {
            ...
            settingsItemStack.setName(lm.settingsAdminButton());
